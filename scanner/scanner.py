...
class Scanner(object):
    _token_table = [
        ...
        Token(TokenType.FUNC, "SIN", 0.0, sin),
        Token(TokenType.FUNC, "COS", 0.0, cos),
        Token(TokenType.FUNC, "TAN", 0.0, tan),
        Token(TokenType.FUNC, "LN", 0.0, log),
        Token(TokenType.FUNC, "EXP", 0.0, exp),
        Token(TokenType.FUNC, "SQRT", 0.0, sqrt),
